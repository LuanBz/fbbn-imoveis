...
<template>
  <main class="p-4 space-y-8 flex flex-col">
      ...
      <div class="flex-col flex gap-4">
        ...
        <div class="flex flex-col">
          <div class="flex gap-2">
            <UBadge color="success">Abaixo do mercado</UBadge
            ><UBadge>Oportunidade</UBadge>
          </div>
          <h2
            class="font-extrabold text-[#141F3F] dark:text-[#F0F0F0] text-3xl uppercase"
          >
            R$
            {{
    ...
    <div class="flex flex-col gap-2">
      ...
      <UButton
        variant="soft"
        class="justify-center bg-[#141F3F] text-white w-full h-15 rounded-lg"
      >
    ...
    <div class="flex flex-col gap-2">
      <div class="flex flex-row gap-2">
        <UCard variant="solid" class="bg-[#F0F0F0] dark:bg-[#141F3F] w-1/3">
          <div class="flex flex-col items-center justify-center gap-2">
            <UIcon
              name="mdi-home"
              class="text-[#141F3F] dark:text-[#F0F0F0] size-12"
            />
            <p class="font-boldtext-[#141F3F] dark:text-[#F0F0F0]">
              {{ property.type }}
            </p>
          </div>
        </UCard>
        <UCard variant="solid" class="bg-[#F0F0F0] dark:bg-[#141F3F] w-1/3">
          <div class="flex flex-col items-center justify-center gap-2">
            <UIcon
              ...
              class="text-[#141F3F] dark:text-[#F0F0F0] size-12"
            />
            <p class="font-bold text-[#141F3F] dark:text-[#F0F0F0]">
              {{ property.delivery }}
            </p>
          </div>
        </UCard>
      ...
      <div
        class="bg-[#F0F0F0] dark:bg-[#141F3F] p-4 rounded-lg flex gap-y-4 flex-wrap justify-center items-center"
      >
        <div class="flex justify-center gap-2 w-1/3">
          <UIcon name="mdi:bed-empty" class="size-6 text-[#c0730f]" />
          <p class="font-medium text-[#141F3F] dark:text-[#F0F0F0]">
      ...
      <div class="dark:bg-[#141F3F] rounded-lg">
        <ul class="list-disc list-inside p-4 gap-2 flex flex-col">
          <li class="font-medium text-[#141F3F] dark:text-[#F0F0F0]">
            Vista para o mar
          </li>
          <li class="font-medium text-[#141F3F] dark:text-[#F0F0F0]">
